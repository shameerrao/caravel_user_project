...
# --- Next steps ---
echo "=== Next steps ==="
echo "1. Source environment: source env.sh"
echo "2. One-time dependency setup (no ChipFoundry CLI):"
echo "     export DISABLE_DEPRECATED_MAKEFILE_PROMPT=1"
echo "     make setup"
echo "3. Configure GPIO defaults (recommended before sim/precheck):"
echo "     python3 scripts/gpio_config.py --set-all GPIO_MODE_USER_STD_INPUT_NOPULL"
echo ""
